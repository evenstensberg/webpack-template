const { initGenerator } = require('@webpack-cli/generators');
const { modifyHelperUtil, npmPackagesExists } = require('@webpack-cli/utils');
...
export default function initializeInquirer(...args) {
    const packages = args;
